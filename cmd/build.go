...
func Build(args []string, stdout, stderr io.Writer) error {
	...
	fs.StringVar(&cfg.Theme, "theme", cfg.Theme, "Theme name (docs, blog, presentation, vanilla)")
...
func printBuildUsage(w io.Writer) {
	...
	_, _ = fmt.Fprintln(w, "  --theme <name>       Theme: docs, blog, presentation, vanilla (default: docs)")
