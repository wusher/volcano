...
`,
  ...
  test("next link navigates to next page", async ({ page }) => {
    ...
    const nextLink = page
      .locator(
        '.page-nav a:has-text("Next"), .next-link, a:has-text("Installation")',
      )
      .first();
  ...
  test("previous link navigates to previous page", async ({ page }) => {
    ...
    const prevLink = page
      .locator(
        '.page-nav a:has-text("Previous"), .prev-link, a:has-text("Introduction")',
      )
      .first();
  ...
  test("first page has no previous link", async ({ page }) => {
    ...
    const prevLink = page.locator(
      '.prev-link:not([disabled]), .page-nav a:has-text("Previous")',
    );
  ...
  test("last page has no next link", async ({ page }) => {
    ...
    const pageText = await page
      .textContent(".page-nav, .pagination")
      .catch(() => "");
