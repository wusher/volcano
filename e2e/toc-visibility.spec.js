...
`,
  ...
  test("TOC should appear when navigating from page without TOC to page with TOC", async ({
    page,
  }) => {
  ...
  test("TOC should disappear when navigating from page with TOC to page without TOC", async ({
    page,
  }) => {
  ...
  test("mobile TOC button should only appear on pages with TOC", async ({
    page,
  }) => {
    ...
    const mobileButtonVisibleBefore =
      await page.isVisible(".mobile-toc-toggle");
