...
func runWithConfig(args []string, cfg *cmd.Config, stdout, stderr io.Writer) (int, error) {
	...
	fs.BoolVar(&cfg.DevMode, "dev", false, "Enable keyboard shortcuts for toggling settings (serve mode)")
...
func printUsage(w io.Writer) {
	...
	_, _ = fmt.Fprintln(w, "  --dev                Enable keyboard shortcuts in serve mode")
